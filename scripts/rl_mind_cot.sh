...
WANDB_RUN_NAME=${WANDB_RUN_NAME:-cot_${REWARD_TYPE}_lr${LEARNING_RATE}_kl${KL_LOSS_COEF}_bs${TRAIN_BATCH_SIZE}_g${NUM_GENERATIONS}_r${MAX_RESPONSE_LENGTH}_h${MAX_HISTORY}_c${MAX_CANDIDATES}_ppo${PPO_MINI_BATCH_SIZE}x${PPO_MICRO_BATCH_SIZE}}
